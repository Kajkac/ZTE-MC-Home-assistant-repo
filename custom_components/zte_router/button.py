...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    async_add_entities([
        ZTERouterButton(main_coordinator, ip_entry, password_entry, router_type, "Reboot Router", "4"),
        ZTERouterButton(main_coordinator, ip_entry, password_entry, router_type, "Delete All SMS", "5"),
        ZTERouterButton(main_coordinator, ip_entry, password_entry, router_type, "Send SMS 50GB", "8"),
        ZTERouterButton(main_coordinator, ip_entry, password_entry, router_type, "Connect Data", "9"),
        ZTERouterButton(main_coordinator, ip_entry, password_entry, router_type, "Disconnect Data", "10"),
        ZTERouterButton(main_coordinator, ip_entry, password_entry, router_type, "Set 5G SA", "11"),
        ZTERouterButton(main_coordinator, ip_entry, password_entry, router_type, "Set 5G NSA", "12")
    ], False)
