...
if __name__ == "__main__":
    ...
    try:
        if command == 1:
            logger.info(f"Calling method: zteinfo with username: {username}, password: {password}")
            result = zte.zteinfo()
        elif command == 2:
            logger.info(f"Calling method: zteinfo2 with username: {username}, password: {password}")
            result = zte.zteinfo2()
        elif command == 3:
            logger.info(f"Calling method: ztesmsinfo with username: {username}, password: {password}")
            result = zte.ztesmsinfo()
        elif command == 4:
            logger.info(f"Calling method: ztereboot with username: {username}, password: {password}")
            result = zte.ztereboot()
        elif command == 5:
            logger.info(f"Calling method: parsesms and deletesms with username: {username}, password: {password}")
            result = zte.parsesms()
            if result:
                ...
                if ids:
                    ...
                    logger.info(f"Calling method: deletesms with msg_ids: {formatted_ids}")
                    result = zte.deletesms(formatted_ids)
                else:
                    logger.info("No SMS in memory")
                    sys.exit(0)
        elif command == 6:
            logger.info(f"Calling method: parsesms with username: {username}, password: {password}")
            result = zte.parsesms()
            if result:
            ...
            logger.info(f"Calling method: zteinfo3 with username: {username}, password: {password}")
            result = zte.zteinfo3()
        elif command == 8:
            logger.info(f"Calling method: sendsms with username: {username}, password: {password}")
            result = zte.sendsms()
        elif command == 9:
            logger.info(f"Calling method: connect_data with username: {username}, password: {password}")
            result = zte.connect_data()
        elif command == 10:
            logger.info(f"Calling method: disconnect_data with username: {username}, password: {password}")
            result = zte.disconnect_data()
        elif command == 11:
            logger.info(f"Calling method: setdata_5G_SA with username: {username}, password: {password}")
            result = zte.setdata_5G_SA()
        elif command == 12:
            logger.info(f"Calling method: setdata_5G_NSA with username: {username}, password: {password}")
